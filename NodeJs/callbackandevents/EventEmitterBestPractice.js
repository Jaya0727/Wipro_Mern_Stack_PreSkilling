function orderPlaced() {
    console.log("orderPlaced function executed");
    return Promise.resolve();
}
function sendEmail() {
    console.log("sendEmail function executed");
    return Promise.resolve();
}
function updateInventory() {
    console.log("updateInventory function executed");
    return Promise.resolve();
}
...
emitter.on("Order Placed" , (data)=>{
    setImmediate(() => console.log("Listener2 started")); // setImmediate is used for event scheduling
